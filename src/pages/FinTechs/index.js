  ...
  const cardIcon = [
    {
      ...
      description:
        "Equipe especializada e com experiência em atender as necessidades específicas de startups financeiras.",
    },
    {
      icon: <MdPalette className="pie" size={50} />,
      title: "Personalização",
      description:
        "Soluções personalizadas para atender as demandas únicas de cada Fintech.",
    },
    {
      icon: <IoIosFlash className="performance" size={70} />,
      title: "Suporte ágil e eficiente",
      description:
        " Atendimento rápido e eficiente para ajudar as Fintechs a solucionar problemas e tomar decisões estratégicas.",
    },
    {
      icon: <FaShieldAlt className="products" size={70} />,
      title: "Compliance e segurança",
      description:
        "Suporte em compliance e segurança para garantir que as Fintechs estejam em conformidade com as regulamentações e tenham uma estrutura segura.",
    },
  ];
