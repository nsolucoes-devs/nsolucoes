  ...
  const cardIcon = [
    {
      ...
      description: "Acompanhe a localização e o status da sua frota em tempo real."
    },
    {
      icon: <BiMap className="pie" size={50} />,
      title: "Otimização de Rotas",
      description: "Reduza o tempo e os custos de deslocamento com o planejamento de rotas mais eficientes."
    },
    {
      icon: <BsTools className="performance" size={50} />,
      title: "Controle de Manutenção",
      description: "Programe e acompanhe a manutenção preventiva da sua frota, evitando problemas e gastos excessivos."
    },
    {
      icon: <FaMoneyBillAlt className="products" size={55} />,
      title: "Gestão de Custos",
      description: "Tenha controle total dos gastos relacionados à sua frota, desde combustível até despesas com manutenção."
    },    
  ]
