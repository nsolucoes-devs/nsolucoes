...
import { Container, Spacing, Budget, Button } from './styles';
...
function MobileApps() {
  ...
  return (
    <Container>
        ...
        <Budget>
          <div className='main-buget' style={{display: "flex", alignItems: "center;", justifyContent: "space-around", marginTop: "70px"}}>
