  ...
  const cardIcon = [
    {
      ...
      description:
        "Suporte rápido e eficiente para resolver os problemas dos clientes.",
    },
    {
      icon: <HiOutlineAdjustments className="pie" size={45} />,
      title: "Customização flexível",
      description:
        "Possibilidade de personalização de acordo com as necessidades do cliente.",
    },
    {
      icon: <FiMonitor className="performance" size={45} />,
      title: "Monitoramento constante",
      description:
        "Acompanhamento contínuo do site/portal para garantir seu funcionamento adequado.",
    },
    {
      icon: <ImLock className="products" size={45} />,
      title: "Segurança garantida",
      description:
        "Implementação de medidas de segurança para proteção dos dados dos usuários e da empresa.",
    },
  ];
